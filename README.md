...
<picture>
  <img src="./assets/output.gif" width="100%" alt="Hero Output" style="border-radius: 12px; filter: contrast(110%) brightness(95%); margin-bottom: 2rem;" />
</picture>
...
<picture>
  <img src="https://github.com/renbkna/renbkna/blob/output/github-contribution-grid-snake.svg" width="100%" style="opacity: 0.9;" alt="Snake Animation" />
</picture>
